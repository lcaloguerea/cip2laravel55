            ...
            <div class="box-register-body">
                ...
                <form class="register-form" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-group input-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        ...
                        <input id="name" class="form-control" type="text" name='name' placeholder="Nombre" required autofocus>
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group input-group{{ $errors->has('lName') ? ' has-error' : '' }}">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                        <input id="lName" class="form-control" type="text" name='lName' placeholder="Apellido" required autofocus>
                        @if ($errors->has('lName'))
                                    <span class="help-block">
