            ...
            <table width="650" border="0" cellspacing="0" cellpadding="0" class="m-shell">
               <tr>
                  <td class="td" style="width:650px; min-width:650px; font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#038b71">
                        <tr>
                           <td class="nav" style="color:#ffffff; font-family:'Amaranth', sans-serif; font-size:20px; line-height:18px; font-weight: 500; text-align:center; min-width:auto !important; padding:15px;">
                             <span class="link-white" style="color:#ffffff; text-decoration:none;">CONSULTA RECIBIDA</span>
                           </td>
                        </tr>
                     </table>
                     <!-- END Navigation -->
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                           <td class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="{{asset('img/emails/question-min.jpg')}}" width="650" height="380" border="0" alt="" /></td>
                        </tr>
                        <tr>
                           <td class="p30-15" style="padding: 50px 30px;">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 ...
                                 <tr>
                                    <td class="text center" style="padding-bottom: 25px; color:#313131; font-family:'Fira Sans', Arial, sans-serif; font-size:14px; line-height:32px; min-width:auto !important; text-align:center;">Se ha recibido una consulta desde la página principal del portal CIP. A continuación los detalles:</td>
                                 </tr>
                                 <tr>
                                    <td class="text center" style="padding-bottom: 5px; color:#313131; font-family:'Fira Sans', Arial, sans-serif; font-size:14px; line-height:32px; min-width:auto !important; text-align:center;"><strong>Nombre: {{$request->name}}</strong> 
                                    </td>
                                 </tr>
                                 <tr>
                                    <td class="text center" style="padding-bottom: 5px; color:#313131; font-family:'Fira Sans', Arial, sans-serif; font-size:14px; line-height:32px; min-width:auto !important; text-align:center;"><strong>Email: {{$request->name}}</strong>
                                    </td>
                                 </tr>                                 
                                 <tr>
                                    <td class="text center" style="padding-bottom: 10px; color:#313131; font-family:'Fira Sans', Arial, sans-serif; font-size:14px; line-height:32px; min-width:auto !important; text-align:center;"><blockquote><cite style="color:gray; font-size: 20px">"{{$request->message}}"</cite></blockquote>
