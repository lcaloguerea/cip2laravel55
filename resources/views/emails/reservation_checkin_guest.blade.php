                        ...
                        <tr>
                           <td style="padding: 50px;" class="p30-15" bgcolor="#488edc">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 ...
                                 <tr>
                                    <td style="padding-bottom: 30px; font-family:'Fira Sans', Arial, sans-serif; font-size:16px; line-height:32px; min-width:auto !important; color:#ffffff; text-align:center;" class="text white center">Para cualquier otra información y/o consulta no dude en comunicarse con nosotros a traves de nuestros medios de contacto.</td>
                                 </tr>
                                 <tr>
                                    <td align="center">
                                       <table border="0" cellspacing="0" cellpadding="0" class="center" style="text-align:center;">
