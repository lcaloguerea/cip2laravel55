            ...
            <table width="650" border="0" cellspacing="0" cellpadding="0" class="m-shell">
               <tr>
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                           <td class="p30-15" style="padding: 50px 30px;">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
                                    <td class="h2 center" style="padding-bottom: 25px; color:#313131; font-family:'Amaranth', Arial, sans-serif; font-size:34px; line-height:44px; text-align:center;">Estimado(a) {{$p1->name_1}},</td>
                                 </tr>
                                 <tr>
                                    <td class="text center" style="padding-bottom: 25px; color:#313131; font-family:'Fira Sans', Arial, sans-serif; font-size:14px; line-height:32px; min-width:auto !important; text-align:center;">Se ha completado exitosamente su ingreso a nuestras dependencias. <br> Como CIP queremos desearle una excelente estadía junto a nosotros, no dude en contactarnos ante cualquier inquietud o consulta. <br><br><strong>cip_reservas<span>@</span>uach<span>.</span>cl</strong><br/>CIP: (63) 2 211136<br/>Administración: +56 8 9209785</td>
                                 </tr>
                              </table>
                           </td>
                        </tr>
                  ...
                  <hr>
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                                    <td class="h2 center" style="padding-bottom: 25px; padding-top: 25px; color:#313131; font-family:'Amaranth', Arial, sans-serif; font-size:34px; line-height:44px; text-align:center;">Su estadía...</td>
                                 </tr>
                                                      ...
                                                      <td style="padding-bottom: 8px;">
                                                         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                               ...
                                                               <td class="text2" style="color:#666666; font-family:'Fira Sans', Arial, sans-serif; font-size:15px; line-height:26px; text-align:center; min-width:auto !important;">Le entregamos a continuación el detalle con toda la información referente a su estadía junto a otros temas de interés.</td>
                                                            </tr>
                                                         </table>
                                                      </td>
                                                   </tr>                          
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
                                    ...
                                    <th class="column-top" width="315" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;">
                                       <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                             <td style="padding-bottom: 22px; font-size:0pt; line-height:0pt; text-align:center;" ><img style="width:237px; height: 237px" src="{{asset($user->uAvatar)}}" width="315" height="237" border="0" alt="" /></td>
                                          </tr>
                                          <tr>
                                             <td class="p0-15">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                           <td style="padding: 50px;" class="p30-15" bgcolor="#488edc">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
                                    <td style="padding-bottom: 30px; font-family:'Amaranth', Arial, sans-serif; font-size:40px; line-height:44px; color:#ffffff; text-align:center;" class="h2 white center">¿Tiene alguna duda?</td>
                                 </tr>
                                 <tr>
                                    <td style="padding-bottom: 30px; font-family:'Fira Sans', Arial, sans-serif; font-size:16px; line-height:32px; min-width:auto !important; color:#ffffff; text-align:center;" class="text white center">Para cualquier otra información y/o consulta no dude en comunicarse con nosotros a través de nuestros medios de contacto.</td>
                                 </tr>
                                 <tr>
                                    <td align="center">
                                       <table border="0" cellspacing="0" cellpadding="0" class="center" style="text-align:center;">
                                          <tr>
                                             <td class="text-button white-button" style="font-family:'Fira Sans', Arial, sans-serif; font-size:15px; line-height:19px; text-align:center; min-width:auto !important; text-transform:uppercase; padding:15px 20px; background:#ffffff; color:#488edc;"><a href="{{env('APP_URL')}}" target="_blank" class="link" style="color:#488edc; text-decoration:none;"><span class="link" style="color:#488edc; text-decoration:none;">Visite nuestra página</span></a></td>
                                          </tr>
                                       </table>
                                    </td>
                                 </tr>
