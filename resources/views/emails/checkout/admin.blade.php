            ...
            <table width="650" border="0" cellspacing="0" cellpadding="0" class="m-shell">
               <tr>
                  <td class="td" style="width:650px; min-width:650px; font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#038b71">
                        <tr>
                           <td class="nav" style="color:#ffffff; font-family:'Amaranth', sans-serif; font-size:20px; line-height:18px; font-weight: 500; text-align:center; min-width:auto !important; padding:15px;">
                             <span class="link-white" style="color:#ffffff; text-decoration:none;">CHECK OUT</span>
                           </td>
                        </tr>
                     </table>
                     <!-- END Navigation -->
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                           <td class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="{{asset('img/emails/check-out-min.jpg')}}" width="650" height="380" border="0" alt="" /></td>
                        </tr>
                        <tr>
                           <td class="p30-15" style="padding: 50px 30px;">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 ...
                                 <tr>
                                    <td class="text center" style="padding-bottom: 25px; color:#313131; font-family:'Fira Sans', Arial, sans-serif; font-size:14px; line-height:32px; min-width:auto !important; text-align:center;">Se ha realizado exitosamente un check Out en la plataforma CIP.</td>
                                 </tr>
                              </table>
                           </td>
                        </tr>
                                                      ...
                                                      <td style="padding-bottom: 8px;">
                                                         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                               ...
                                                               <td class="text2" style="padding-bottom: 25px; color:#313131; font-family:'Fira Sans', Arial, sans-serif; font-size:14px; line-height:32px; min-width:auto !important; text-align:center;">La confirmación de este Check Out ha sido efectuada por <strong>{{$act->rspnsblR->name}} {{$act->rspnsblR->lName}}</strong>. Con fecha <strong>{{$act->created_at}}</strong></td>
                                                            </tr>
                                                         </table>
                                                      </td>
                                                   </tr>                          
                                                      ...
                                                      <td style="padding-bottom: 8px;">
                                                         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                               ...
                                                               <td class="text2" style="color:#666666; font-family:'Fira Sans', Arial, sans-serif; font-size:15px; line-height:26px; text-align:left; min-width:auto !important;">Se ha cambiado el estado de la <strong>limpieza</strong> referente a la habitación <strong>N°{{$Reserv->room_id}}</strong>  como pendiente.</td>
                                                            </tr>
                                                         </table>
                                                      </td>
                                                   </tr> 
                                                   <tr>
                                                      <td style="padding-bottom: 8px;">
                                                         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                               <td class="img" width="22" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="https://icon2.cleanpng.com/20171220/euw/exclamation-mark-png-5a3a528f0b35d2.1572392815137716630459.jpg" width="10" height="20" border="0" alt="" /></td>
                                                               <td class="text2" style="color:#666666; font-family:'Fira Sans', Arial, sans-serif; font-size:15px; line-height:26px; text-align:left; min-width:auto !important;">La habitación <strong>N°{{$Reserv->room_id}}</strong> ha quedado bloqueada en espera de las labores de aseo correspondientes.</td>
                                                            </tr>
                                                         </table>
                                                      </td>
                                                   </tr>
