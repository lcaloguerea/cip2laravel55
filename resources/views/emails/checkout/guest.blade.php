                        ...
                        <tr>
                           <td class="p30-15" style="padding: 50px 30px;">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 ...
                                 <tr>
                                    <td class="text center" style="padding-bottom: 25px; color:#313131; font-family:'Fira Sans', Arial, sans-serif; font-size:14px; line-height:32px; min-width:auto !important; text-align:center;">Se ha completado exitosamente el fin de su estadía junto a nosotros. <br><br> Como CIP esperamos que su experiencia en nuestras dependencias haya sido de su total agrado.</td>
                                 </tr>
                              </table>
                           </td>
                        </tr>
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                           <td style="padding: 50px;" class="p30-15" bgcolor="#488edc">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
                                    <td style="padding-bottom: 30px; font-family:'Amaranth', Arial, sans-serif; font-size:40px; line-height:44px; color:#ffffff; text-align:center;" class="h2 white center">¿Nos brindaría su testimonio?</td>
                                 </tr>
                                 <tr>
                                    <td style="padding-bottom: 30px; font-family:'Fira Sans', Arial, sans-serif; font-size:16px; line-height:32px; min-width:auto !important; color:#ffffff; text-align:center;" class="text white center">Nos gustaría poder registrar el testimonio de su experiencia junto a nosotros como también su valoración de nuestros servicios.</td>
                                 </tr>
                                 <tr>
                                    <td align="center">
                                       <table border="0" cellspacing="0" cellpadding="0" class="center" style="text-align:center;">
