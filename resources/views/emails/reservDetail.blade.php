                ...
                <table cellpadding="0" cellspacing="0" width="600" class="w320">
                  <tr>
                    <td class="pull-middle mobile-header-padding-middle" style="vertical-align: middle;">
                      <a href=""><h1 style="color:white">Detalle de reserva</h1></a>
                    </td>
                  </tr>
                </table>
              </center>
    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
              Gracias por reservar tu estadía
            </td>
          </tr>
          <tr>
            <td class="free-text">
              Agradecemos su preferencia, su reserva se encuentra registrada. Detalles a continuación.
            </td>
          </tr>
          <tr>
            <td class="w320">
                      ...
                      <tr>
                        <td class="mini-block-padding">
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                <span class="header-sm">Solicitante</span><br/>
                                Nombre Apellido <br />
                                Departamento <br />
                                Telefono <br />
                                Correo
                      ...
                      <tr>
                        <td class="mini-block-padding">
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                                <span class="header-sm">Fecha ingreso de reserva</span><br />
                                January 12, 2015 <br />
                                <br />
                                <strong>Código de reserva:</strong>  #12 <br />
                                <strong>Tipo de habitación:</strong> Compartida <br />
                              </td>
                            </tr>
                          </table>
                        </td>
                    ...
                    <td class="item-col item">
                      <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                          ...
                          <td class="product">
                            <span style="color: #4d4d4d; font-weight:bold;">Nombre</span> <br />
                            Apellido <br>
                            Nacionalidad <br>
                            Fono <br>
                            correo
