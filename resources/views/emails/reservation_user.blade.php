               ...
               <tr>
                        ...
                        <tr>
                           <td class="p30-15" style="padding: 50px 30px;">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 ...
                                 <tr>
                                    <td class="text center" style="padding-bottom: 25px; color:#313131; font-family:'Fira Sans', Arial, sans-serif; font-size:14px; line-height:32px; min-width:auto !important; text-align:center;">Su reserva está registrada:</td>
                                 </tr>
                              </table>
                           </td>
                        </tr>
                  ...
                  <hr>
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                      ...
                                                      <td style="padding-bottom: 8px;">
                                                         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                               ...
                                                               <td class="text2" style="color:#666666; font-family:'Fira Sans', Arial, sans-serif; font-size:15px; line-height:26px; text-align:left; min-width:auto !important;">Fechas: {{date('d-m-Y', strtotime($Reserv->check_in))}} a {{date('d-m-Y', strtotime($Reserv->check_out))}}</td>
                                                            </tr>
                                                         </table>
                                                      </td>
                                                   </tr>
                                                   ...
                                                   <tr>
                                                      <td style="padding-bottom: 8px;">
                                                         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                               <td class="img" width="22" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="https://img.icons8.com/cotton/2x/cash-in-hand.png" width="15" height="20" border="0" alt="" /></td>
                                                               <td class="text2" style="color:#666666; font-family:'Fira Sans', Arial, sans-serif; font-size:15px; line-height:26px; text-align:left; min-width:auto !important;">Medio de pago: {{trans('attributes.'.$Reserv->payment_m)}}</td>
                                                            </tr>
                                                         </table>
                                                      </td>
                                                   </tr>
                                    ...
                                    <th class="column-top" width="315" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;">
                                       <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                             <td style="padding-bottom: 22px; font-size:0pt; line-height:0pt; text-align:left;" class="fluid-img"><img src="https://img.elcomercio.pe/files/article_content_ec_fotos/uploads/2017/03/29/58dc7a567399a.jpeg" width="315" height="237" border="0" alt="" /></td>
                                          </tr>
                                          <tr>
                                             <td class="p0-15">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                   <tr>
                                                      <td style="padding-bottom: 18px; color:#0e2337; font-family:'Amaranth', sans-serif; font-size:22px; line-height:32px; text-align:left;" class="h3">Contamos con:</td>
                                                   </tr>
                                    <th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
                                       <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                                      ...
                                                      <td style="padding-bottom: 8px;">
                                                         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                               ...
                                                               <td class="text2" style="color:#666666; font-family:'Fira Sans', Arial, sans-serif; font-size:15px; line-height:26px; text-align:left; min-width:auto !important;">cocina equipada.</td>
                                                            </tr>
                                                         </table>
                                                      </td>
                                                   </tr>
                                                   <tr>
                                                      <td style="padding-bottom: 8px;">
                                                         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                               <td class="img" width="22" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="https://img.pngio.com/check-correct-mark-success-tick-valid-yes-icon-check-icon-valid-png-512_512.png" width="10" height="20" border="0" alt="" /></td>
                                                               <td class="text2" style="color:#666666; font-family:'Fira Sans', Arial, sans-serif; font-size:15px; line-height:26px; text-align:left; min-width:auto !important;">Desayuno es autoservicio, consiste en café de grano, té, leche, pan, mantequilla y mermelada.</td>
                                                            </tr>
                                                         </table>
                                                      </td>
                                                   </tr>
                                                   <tr>
                                                      <td style="padding-bottom: 8px;">
                                                         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                               <td class="img" width="22" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="https://img.pngio.com/check-correct-mark-success-tick-valid-yes-icon-check-icon-valid-png-512_512.png" width="10" height="20" border="0" alt="" /></td>
                                                               <td class="text2" style="color:#666666; font-family:'Fira Sans', Arial, sans-serif; font-size:15px; line-height:26px; text-align:left; min-width:auto !important;">Ofrecemos servicio de mucama y aseo de lunes a viernes.</td>
                                                            </tr>
                                                         </table>
                                                      </td>
                                                   </tr>
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-top: 70px">
                        <tr>
                           <td class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="https://www.pqs.pe/sites/default/files/styles/852x479/public/2016/06/blog/dudas-clientes.png?itok=8S_71F6k" width="650" height="380" border="0" alt="" /></td>
                        </tr>
                        <tr>
                           <td class="p30-15" style="padding: 50px 30px;">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
                                    <td class="h2 center" style="padding-bottom: 25px; color:#313131; font-family:'Amaranth', Arial, sans-serif; font-size:34px; line-height:44px; text-align:center;">Atención!,</td>
                                 </tr>
                                 <tr>
                                    <td class="text center" style="padding-bottom: 25px; color:#313131; font-family:'Fira Sans', Arial, sans-serif; font-size:14px; line-height:32px; min-width:auto !important; text-align:center;">La CIP se reserva el derecho de admisión en casos de no pago o conducta inapropiada por parte de su invitado(a).</td>
                                 </tr>
                                 <tr>
                                    <td class="text center" style="padding-bottom: 25px; color:#313131; font-family:'Fira Sans', Arial, sans-serif; font-size:14px; line-height:32px; min-width:auto !important; text-align:center;">Las reservas se realizan sólo en esta plataforma, si tiene alguna consulta nos escribe a: <strong>cip_reservas<span>@</span>uach<span>.</span>cl</strong></td>
                                 </tr>
                              </table>
                           </td>
                        </tr>
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-top: 70px">
                        ...
                        <tr>
                           <td class="p30-15" style="padding: 50px 30px;">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
                                    <td class="h2 center" style="padding-bottom: 25px; color:#313131; font-family:'Amaranth', Arial, sans-serif; font-size:34px; line-height:44px; text-align:center;">Normas de uso:</td>
                                 </tr>
                                    <th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
                                       <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                                   ...
                                                   <tr>
                                                      <td style="padding-bottom: 8px;">
                                                         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                               <td class="img" width="22" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="https://img.pngio.com/check-correct-mark-success-tick-valid-yes-icon-check-icon-valid-png-512_512.png" width="10" height="20" border="0" alt="" /></td>
                                                               <td class="text2" style="color:#666666; font-family:'Fira Sans', Arial, sans-serif; font-size:15px; line-height:26px; text-align:left; min-width:auto !important;">Las habitaciones son exclusivamente para los huéspedes, no está permitido el ingreso de acompañantes. Si su invitado(a) viene acompañado, debe completar registro y se realizará el cobro adicional.</td>
                                                            </tr>
                                                         </table>
                                                      </td>
                                                   </tr>
                                                   <tr>
                                                      <td style="padding-bottom: 8px;">
                                                         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                               <td class="img" width="22" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="https://img.pngio.com/check-correct-mark-success-tick-valid-yes-icon-check-icon-valid-png-512_512.png" width="10" height="20" border="0" alt="" /></td>
                                                               <td class="text2" style="color:#666666; font-family:'Fira Sans', Arial, sans-serif; font-size:15px; line-height:26px; text-align:left; min-width:auto !important;">El <strong>Check in</strong> es de lunes a viernes a partir de las 15:00 horas, consulte si es posible recibir a su invitado en otro horario. Los fines de semana y festivos se coordina entrega de llaves, usted debe informar la hora de llegada. Si prefiere recibir a su invitado(a) puede contactarse con nosotros, recibir las instrucciones y llaves correspondientes.</td>
                                                            </tr>
                                                         </table>
                                                      </td>
                                                   </tr>
                                                   <tr>
                                                      <td style="padding-bottom: 8px;">
                                                         <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                               <td class="img" width="22" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="https://img.pngio.com/check-correct-mark-success-tick-valid-yes-icon-check-icon-valid-png-512_512.png" width="10" height="20" border="0" alt="" /></td>
                                                               <td class="text2" style="color:#666666; font-family:'Fira Sans', Arial, sans-serif; font-size:15px; line-height:26px; text-align:left; min-width:auto !important;">El <strong>Check out</strong> es hasta las 12:00 AM. Fuera de ese horario se realizará cobro correspondiente a medio día. Si desean extender estadía favor revisar disponibilidad de reservas.</td>
                                                            </tr>
                                                         </table>
                                                      </td>
                                                   </tr>                                                 
                  ...
                  <hr>
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-top: 70px">
                        <tr>
                           <td class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="http://blog.bcbsnc.com/wp-content/uploads/2016/11/shutterstock_248825623-1-1080x675.jpg" width="650" height="380" border="0" alt="" /></td>
                        </tr>
                        <tr>
                           <td class="p30-15" style="padding: 50px 30px;">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
                                    <td class="h2 center" style="padding-bottom: 25px; color:#313131; font-family:'Amaranth', Arial, sans-serif; font-size:34px; line-height:44px; text-align:center;">Pagos:</td>
                                 </tr>
                                 <tr>
                                    <td class="text center" style="padding-bottom: 25px; color:#313131; font-family:'Fira Sans', Arial, sans-serif; font-size:14px; line-height:32px; min-width:auto !important; text-align:center;">Recuerde que puede anular la reserva dentro de 24 horas de la fecha de entrada. Si su invitado no se presenta, se realizará el cobro correspondiente a la unidad que hizo la reserva. 
                                    </td>
                                 </tr>
                                 <tr>
                                    <td class="h2 center" style="padding-bottom: 25px; color:#313131; font-family:'Amaranth', Arial, sans-serif; font-size:34px; line-height:44px; text-align:center;">Forma de pago</td>
                                 </tr>
                                 <tr>
                                    <td class="text center" style="padding-bottom: 25px; color:#313131; font-family:'Fira Sans', Arial, sans-serif; font-size:14px; line-height:32px; min-width:auto !important; text-align:center;">No se aceptan tarjetas bancarias, sólo pagos en efectivo, transferencia o cargo a código presupuestario. En caso de que su invitado(a) no realice el pago, se realizará el cobro a la unidad que realizó la reserva. <br><br> El pago en efectivo se realizará en la CIP, se recibe moneda nacional/extranjera, cheque nominativo a nombre de la Universidad Austral de Chile.
                                    </td>
                                 </tr>
                                 <tr>
                                    <td class="text center" style="padding-bottom: 25px; color:#313131; font-family:'Fira Sans', Arial, sans-serif; font-size:14px; line-height:32px; min-width:auto !important; text-align:center;"><u><strong>Transferencia moneda nacional:</u></strong><br>Universidad Austral de Chile <br> Rut 81.380.500-6<br>Banco Santander <br> Cuenta corriente  0-000-2591303-5 <br> carolinadiaz<span>@</span>uach<span>.</span>cl
                                    </td>
                                 </tr>  
                                 <tr>
                                    <td class="text center" style="padding-bottom: 25px; color:#313131; font-family:'Fira Sans', Arial, sans-serif; font-size:14px; line-height:32px; min-width:auto !important; text-align:center;"><u><strong>Transferencia moneda extranjera:</u></strong><br>Universidad Austral de Chile <br> Rut 81.380.500-6<br>Banco Santander Chile<br> Banco corresponsal: PNBPUS3NNYC (wachovia Bank N.A. New York) <br> ABA : 026005092 <br> Cuenta corriente N°00510004997-1 <br> Swiff Bic Address:  BSCHCLRM <br> Dirección: Pérez Rosales 585 Valdivia - Chile <br> carolinadiaz<span>@</span>uach<span>.</span>cl
                                    </td>
                                 </tr>
                                 <tr>
                                    <td class="text center" style="padding-bottom: 25px; color:#313131; font-family:'Fira Sans', Arial, sans-serif; font-size:14px; line-height:32px; min-width:auto !important; text-align:center;"><u><strong>Comprobante de pago:</u></strong><br>Se entrega un comprobante de recaudación de uso interno, en el caso de requerir boleta de ventas o factura debe considerar el IVA. Para atender sus consultas y coordinar recaudación, contactarse con carolinadiaz<span>@</span>uach<span>.</span>cl
                                    </td>
                                 </tr>                                                                                                 
                              </table>
                           </td>
                        ...
                        <tr>
                           <td style="padding: 50px;" class="p30-15" bgcolor="#488edc">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 ...
                                 <tr>
                                    <td style="padding-bottom: 30px; font-family:'Fira Sans', Arial, sans-serif; font-size:16px; line-height:32px; min-width:auto !important; color:#ffffff; text-align:center;" class="text white center">Recuerde que toda esta información puede ser revisada en su historial de reservas almacenadas en nuestra plataforma.</td>
                                 </tr>
                                 <tr>
                                    <td align="center">
                                       <table border="0" cellspacing="0" cellpadding="0" class="center" style="text-align:center;">
