            ...
            <table width="650" border="0" cellspacing="0" cellpadding="0" class="m-shell">
               <tr>
                  <td class="td" style="width:650px; min-width:650px; font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
                                          ...
                                          <tr>
                                             <td align="left">
                                                <table border="0" cellspacing="0" cellpadding="0" class="center" style="text-align:center;">
                                                   <tr>
                                                      <td class="text-top" style="padding-left: 10px; color:#038b71; font-family:'Amaranth', Arial, sans-serif; font-size:30px; line-height:20px; text-align:left; min-width:auto !important;">CIP</td>
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#038b71">
                        <tr>
                           <td class="nav" style="color:#ffffff; font-family:'Amaranth', Arial, sans-serif; font-size:20px; line-height:18px; font-weight: 500; text-align:center; min-width:auto !important; padding:15px;">
                             <span class="link-white" style="color:#ffffff; text-decoration:none;">TE DAMOS LA BIENVENIDA</span>
                           </td>
                        </tr>
                     </table>
                     <!-- END Navigation -->
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                           <td class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="https://i.ibb.co/5KNy8y1/front-building.jpg" width="650" height="380" border="0" alt="" /></td>
                        </tr>
                        <tr>
                           <td class="p30-15" style="padding: 50px 30px;">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 ...
                                 <tr>
                                    <td class="text center" style="padding-bottom: 25px; color:#313131; font-family:'Fira Sans', Arial, sans-serif; font-size:14px; line-height:32px; min-width:auto !important; text-align:center;">La Casa de Investigación y Postgrado fue creada en el marco del PMI AUS1203 Proyecto Mecesup del Ministerio de Educación, para la Internacionalización de Programas de Doctorado de la Universidad Austral de Chile. <br><br>Su objetivo es otorgar facilidades a los académicos y estudiantes internacionales/nacionales que nos visitan.</td>
                                 </tr>
                              </table>
                           </td>
                        </tr>
                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                           <td style="padding: 50px;" class="p30-15" bgcolor="#488edc">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
                                    <td style="padding-bottom: 30px; font-family:'Amaranth', Arial, sans-serif; font-size:40px; line-height:44px; color:#ffffff; text-align:center;" class="h2 white center">Ya estamos casi listos...</td>
                                 </tr>
                                 <tr>
                                    <td style="padding-bottom: 30px; font-family:'Fira Sans', Arial, sans-serif; font-size:16px; line-height:32px; min-width:auto !important; color:#ffffff; text-align:center;" class="text white center">Para poder hacer uso de nuestra plataforma solo debes finalizar tu registro confirmandolo en el siguiente botón.</td>
                                 </tr>
                                 <tr>
                                    <td align="center">
                                       <table border="0" cellspacing="0" cellpadding="0" class="center" style="text-align:center;">
                                          <tr>
                                             <td class="text-button white-button" style="font-family:'Fira Sans', Arial, sans-serif; font-size:15px; line-height:19px; text-align:center; min-width:auto !important; text-transform:uppercase; padding:15px 20px; background:#ffffff; color:#488edc;"><a href="{{ URL::to('http://127.0.0.1:8000/register/verify/' . $codigo) }}" target="_blank" class="link" style="color:#488edc; text-decoration:none;"><span class="link" style="color:#488edc; text-decoration:none;">Confirmar</span></a></td>
                                          </tr>
                                       </table>
                                    </td>
                                 </tr>
