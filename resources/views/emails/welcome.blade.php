                ...
                <table cellpadding="0" cellspacing="0" width="600" class="w320">
                  <tr>
                    <td class="pull-middle mobile-header-padding-middle" style="vertical-align: middle;">
                      <a href=""><h1 style="color:white">Bienvenido a CIP</h1></a>
                    </td>
                  </tr>
                </table>
              </center>
    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        ...
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
              Estimad@ <strong>{{ $destinatario }}</strong>,
              <br>
              <br>
              La Casa de Investigadores y Postgrado fue creada con el objetivo de otorgar facilidades a los académicos y estudiantes internacionales/nacionales que nos visitan.
            </td>
          </tr>
          <tr>
            <td class="mini-block-container">
