                     ...
                     <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#038b71">
                        <tr>
                           <td class="nav" style="color:#ffffff; font-family:'Amaranth', Arial, sans-serif; font-size:20px; line-height:18px; font-weight: 500; text-align:center; min-width:auto !important; padding:15px;">
                             <span class="link-white" style="color:#ffffff; text-decoration:none;">CAMBIAR CONTRASEÑA</span>
                           </td>
                        </tr>
                     </table>
                     <!-- END Navigation -->
                        ...
                        <tr>
                           <td class="p30-15" style="padding: 50px 30px;">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 ...
                                 <tr>
                                    <td class="text center" style="padding-bottom: 25px; color:#313131; font-family:'Fira Sans', Arial, sans-serif; font-size:14px; line-height:32px; min-width:auto !important; text-align:center;">Hemos recibido una solicitud para cambiar la contraseña de acceso a nuestra plataforma CIP, si usted no lo ha solicitado, rogamos dejar sin efecto este correo.</td>
                                 </tr>
                                          <tr>
                                             <td class="text-button blue-button" style="font-family:'Fira Sans', Arial, sans-serif; font-size:15px; line-height:19px; text-align:center; min-width:auto !important; text-transform:uppercase; padding:15px 20px; background:#ffffff; color:#488edc;"><a href="{{ URL::to('http://127.0.0.1:8000/password/reset/' . $codigo) }}" target="_blank" class="link" style="color:#488edc; text-decoration:none;"><span class="link" style="color:#488edc; text-decoration:none;">Cambiar contraseña</span></a></td>
                                          </tr>
                                 <tr>
                                    <td class="text center" style="padding-bottom: 25px; color:#313131; font-family:'Fira Sans', Arial, sans-serif; font-size:14px; line-height:32px; min-width:auto !important; text-align:center;">A continuación, le recordamos información importante.</td>
                                 </tr>                                    
                                 </tr>
                              </table>
                           </td>
