        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-title">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="/user/"><i class="fa fa-home"></i>Inicio</a></li>
                        <li class="active">Perfil Huésped</li>
                    </ol>
                </section>
                            ...
                            <div class="nav-tabs-custom">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab_1">
                                            @if($act->count() == 0)
                                                <div style="text-align: center" class="alert alert-warning alert-dismissable"><strong>No registra actividad </strong>(Solo se mostrará actividad de huéspedes que usted haya patrocinado/vinculado a una reserva)</div>
                                                <ul class="timeline">
                                            @else
                                                    ...
                                                    <div class='row'>
                                                        <div class='col-md-4'>
                                                            <div class='form-group'>
                                                                ...
                                                                <br>
                                                                <img style="height: 20px; width: 30px" src="https://restcountries.eu/data/{{strtolower($passenger->nationality)}}.svg">
                                                            </div>
                                                        </div>
                                                        <div class='col-md-4'>
                                                            <div class="form-group">
                                                                <label>Origen:</label>
                                                                <br>
                                                                <img style="height: 20px; width: 30px" src="{{$passenger->countryo->flag}}">
                                                            </div>
                                                        </div>
                                                        <div class='col-md-4'>
                                                            <div class='form-group'>
                                                                ...
                                                                <br>
                                                                <img style="height: 20px; width: 30px" src="{{$passenger->countryr->flag}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class='row'>
